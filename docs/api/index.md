...
<p style='text-align: justify;'>
    &emsp;&emsp;Welcome to the PyORlib API Reference, a comprehensive guide that provides detailed information about
	the classes, functions, parameters, attributes, and other components available in PyORlib.
</p> 
...
<p style='text-align: right;' markdown>
    *Let's explore the PyORlib API Reference!*
</p> 
